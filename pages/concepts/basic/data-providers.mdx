...
When it comes to resolving the Conditions, the Data Provider on Azuro observes a certain set of rules, derived from one of the most reputable established sports-betting data sources (https://www.pinnacle.com/en/future/betting-rules). 

It is envisioned that there may be multiple data providers active on Azuro at a a later stage, therefore these rules may change, evolve or vary depending on the data provider in the future.
